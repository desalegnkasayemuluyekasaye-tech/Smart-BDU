    ...
    <div className="app">
      ...
      <nav className="top-navbar">
        <div className="nav-brand">
          ...
          <span className="brand-text">SmartBDU</span>
        </div>
        ...
        <div className="nav-links">
          ...
          <NavLink to="/app" className={({ isActive }) => `nav-link-item ${isActive ? 'active' : ''}`}>
            📊 Dashboard
          </NavLink>
          <button className="nav-link-item ai-btn" onClick={() => setMenuOpen(!menuOpen)}>
            🤖 AI Help
          </button>
        </div>
      ...
      <aside className="sidebar">
        ...
        <ul className="nav-menu">
          <li className="nav-item">
            <NavLink to="/app" className={({ isActive }) => `nav-link ${isActive ? 'active' : ''}`} end>
              <svg viewBox="0 0 24 24" fill="currentColor"><path d="M3 13h8V3H3v10zm0 8h8v-6H3v6zm10 0h8V11h-8v10zm0-18v6h8V3h-8z"/></svg>
              <span>Dashboard</span>
            </NavLink>
          </li>
          <li className="nav-item">
            <NavLink to="/app/schedule" className={({ isActive }) => `nav-link ${isActive ? 'active' : ''}`}>
          ...
          <li className="nav-item">
            <NavLink to="/app/announcements" className={({ isActive }) => `nav-link ${isActive ? 'active' : ''}`}>
          ...
          <li className="nav-item">
            <NavLink to="/app/courses" className={({ isActive }) => `nav-link ${isActive ? 'active' : ''}`}>
          ...
          <li className="nav-item">
            <NavLink to="/app/services" className={({ isActive }) => `nav-link ${isActive ? 'active' : ''}`}>
          ...
          <li className="nav-item">
            <NavLink to="/app/directory" className={({ isActive }) => `nav-link ${isActive ? 'active' : ''}`}>
              <svg viewBox="0 0 24 24" fill="currentColor"><path d="M12 12c2.21 0 4-1.79 4-4s-1.79-4-4-4-4 1.79-4 4 1.79 4 4 4zm0 2c-2.67 0-8 1.34-8 4v2h16v-2c0-2.66-5.33-4-8-4z"/></svg>
              <span>Directory</span>
            </NavLink>
          </li>
          <li className="nav-item">
            <NavLink to="/app/ai-assistant" className={({ isActive }) => `nav-link ${isActive ? 'active' : ''}`}>
